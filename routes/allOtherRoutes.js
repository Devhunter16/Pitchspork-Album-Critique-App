...
router.get('/bestAlbums', async (req, res) => {
...
router.get('/updateCollection', async (req, res) => {
    const { id } = req.params;
...
router.get('/viewInfo/:id', async (req, res) => {
    const { id } = req.params;
...
router.get('/editInfo/:id', async (req, res) => {
    const { id } = req.params;
    const record = await Record.findById(id);
...
router.get('/showArtist/:id', async (req, res) => {
    const { id } = req.params;
